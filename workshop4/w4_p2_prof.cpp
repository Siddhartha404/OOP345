...
#include "Reservation.h" // intentional
    ...
    #error "The header guard for 'Reservation.h' doesn't follow the convention!"
#endif
#ifndef SENECA_CONFIRMATIONSENDER_H
    #error "The header guard for 'ConfirmationSender.h' doesn't follow the convention!"
#endif
#ifndef SENECA_RESTAURANT_H
    #error "The header guard for 'Restaurant.h' doesn't follow the convention!"
#endif
